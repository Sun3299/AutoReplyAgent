...
class PipelineResult:
    ...
    def __init__(
        self, success: bool, context: PipelineContext, trace: Optional[Trace] = None
    ):
...
class PipelineOrchestrator:
    ...
    def execute(
        ...
        for step_name in self.step_order:
            ...
            print(f"[ORCHESTRATOR] Executing step: {step_name}", flush=True)
            ...
            print(
                f"[ORCHESTRATOR] Step {step_name} completed in {step_duration * 1000:.1f}ms, success={step_result.success}",
                flush=True,
            )
            ...
            if not step_result.success and not step.optional:
                ...
                print(
                    f"[ORCHESTRATOR] Step {step_name} failed: {step_result.error}",
                    flush=True,
                )
